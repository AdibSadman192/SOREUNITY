    ...
    <div className="space-y-6">
      <div className="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
        ...
        <div className="mt-3 text-sm text-gray-500">
          <p>Manage customer relationships and track interactions</p>
        </div>
      </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Loyalty Program</dt>
                  <dd className="mt-2">
        ...
        <div className="p-4">
          <div className="sm:flex sm:items-center">
            <div className="sm:flex-auto">
              ...
              <p className="mt-2 text-sm text-gray-500">A list of all customers in your database.</p>
            </div>
